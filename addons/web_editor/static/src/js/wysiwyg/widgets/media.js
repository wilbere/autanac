autanac.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in autanac.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" autanac domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in autanac.
 */
...
/**
 * Let users choose a document, including uploading a new document in autanac.
 */
