...
from autanac import _, api, exceptions, fields, models, tools, registry, SUPERUSER_ID
from autanac.osv import expression

from autanac.tools import pycompat, ustr
from autanac.tools.misc import clean_context, split_every
   ...
   Only allowed people can contact us at this address.</p>
    ...
    def message_post(self, *,
        ...
        if values['author_id'] and values['message_type'] != 'notification' and not self._context.get('mail_create_nosubscribe'):
            # if self.env['res.partner'].browse(values['author_id']).active:  # we dont want to add autanacbot/inactive as a follower
    ...
    def message_post_with_view(self, views_or_xmlid, **kwargs):
        ...
        try:
            from autanac.addons.http_routing.models.ir_http import slug
            values['slug'] = slug
        except ImportError:
