...
from autanac import api, release, SUPERUSER_ID
from autanac.exceptions import UserError
from autanac.models import AbstractModel
from autanac.tools.translate import _
from autanac.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to autanac's publisher warranty server to check the
