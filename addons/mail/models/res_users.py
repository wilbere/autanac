...
from autanac import _, api, exceptions, fields, models, modules
from autanac.addons.base.models.res_users import is_selection_groups
...
class Users(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        ('inbox', 'Handle in autanac')],
        'Notification', required=True, default='email',
        help="Policy on how to handle Chatter notifications:\n"
             "- Handle by Emails: notifications are sent to your email address\n"
             "- Handle in autanac: notifications appear in your autanac Inbox")
