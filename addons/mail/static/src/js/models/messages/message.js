autanac.define('mail.model.Message', function (require) {
"use strict";
...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    getAvatarSource: function () {
        if (this._isautanacbotAuthor()) {
            return '/mail/static/src/img/autanacbot.png';
     ...
     *
     * Do not redirect on author clicked of self-posted or autanacbot messages
     * (note: autanacbot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isautanacbotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If autanacbot is the author (default author for transient messages),
     * returns 'autanacbot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is autanacBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isautanacbotAuthor: function () {
        return this._serverAuthorID &&
            this._serverAuthorID[0] === this.call('mail_service', 'getautanacbotID')[0];
    },
    /**
