...
from autanac import api, fields, models, _, SUPERUSER_ID
from autanac.exceptions import UserError
from autanac.osv import expression
from autanac.tools.float_utils import float_compare, float_round, float_is_zero
        ...
        if self.product_qty < self._origin.product_qty:
            warning_mess = {
                ...
                'message' : _("By changing this quantity here, you accept the "
                              "new quantity as complete: autanac will not "
