...
from autanac import api, fields, models, SUPERUSER_ID, _
from autanac.osv import expression
from autanac.tools import DEFAULT_SERVER_DATETIME_FORMAT
from autanac.tools.float_utils import float_compare, float_is_zero, float_round
from autanac.exceptions import UserError
from autanac.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, autanac will automatically pre-fill the detailed "
