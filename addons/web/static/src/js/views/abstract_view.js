autanac.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. autanac JS views are the
 ...
 * the word 'view' has historical significance in autanac code, so we replaced the
