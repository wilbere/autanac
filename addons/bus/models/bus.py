...
import autanac
from autanac import api, fields, models, SUPERUSER_ID
from autanac.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
from autanac.tools import date_utils
...
class ImBus(models.Model):
    ...
    def sendmany(self, notifications):
        ...
        if channels:
            ...
            def notify():
                with autanac.sql_db.db_connect('postgres').cursor() as cr:
...
dispatch = None
if not autanac.multi_process or autanac.evented:
