autanac.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether autanac is focused or not
     *
     * @returns {boolean}
     */
    isautanacFocused: function () {
        return this._isautanacFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isautanacFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isautanacFocused);
        }
    },
    /**
