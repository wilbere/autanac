...
from autanac.tools.misc import ustr

from autanac.addons.base.models.ir_mail_server import MailDeliveryException
from autanac.addons.auth_signup.models.res_partner import SignupError, now
