...
from autanac import api, fields, models, tools
import autanac.addons
...
dp = sys.modules['autanac.addons.base.models.decimal_precision']
autanac.addons.decimal_precision = dp
sys.modules['autanac.addons.decimal_precision'] = dp
