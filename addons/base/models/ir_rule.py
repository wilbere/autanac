...
from autanac.exceptions import AccessError, ValidationError
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - autanac/addons/test_access_rights/tests/test_feedback.py
        # - autanac/addons/test_access_rights/tests/test_ir_rules.py
        # - autanac/addons/base/tests/test_orm.py (/home/dle/src/autanac/master-nochange-fp/autanac/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
