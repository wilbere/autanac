...
from autanac.exceptions import CacheMiss
...
class Field(MetaField('DummyField', (object,), {})):
    ...
    :param str group_operator: aggregate function used by :meth:`~autanac.models.Model.read_group`
    ...
    def cache_key(self, env):
        ...
        def get(key, get_context=env.context.get):
            if key == 'force_company':
                ...
                # https://github.com/autanac/autanac/blob/4b06fe19fa68255b7982d15e5847da2f6d6209fd/addons/web/static/src/js/views/control_panel/control_panel_model.js#L962
...
class Float(Field):
    ...
    :param digits: a pair (total, decimal) or a string referencing a
        :class:`~autanac.addons.base.models.decimal_precision.DecimalPrecision` record name.
...
class Monetary(Field):
    ...
    :class:`res_currency<autanac.addons.base.models.res_currency.Currency>`.
    ...
    :param str currency_field: name of the :class:`Many2one` field
        holding the :class:`res_currency <autanac.addons.base.models.res_currency.Currency>`
    ...
    def convert_to_cache(self, value, record, validate=True):
        ...
        if value and validate:
            # FIXME @rco-autanac: currency may not be already initialized if it is
...
class Image(Binary):
    ...
    :param bool verify_resolution: whether the image resolution should be verified
        ...
        See :class:`autanac.tools.image.ImageProcess` for maximum image resolution (default: ``45e6``).
...
class Many2one(_Relational):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~autanac.models.Model._check_company`. Add a default company
