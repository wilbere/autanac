...
class PostgreSQLHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        if not dbname:
            return
        with tools.ignore(Exception), tools.mute_logger('autanac.sql_db'), sql_db.db_connect(dbname, allow_uri=True).cursor() as cr:
...
DEFAULT_LOG_CONFIGURATION = [
    'autanac.http.rpc.request:INFO',
    'autanac.http.rpc.response:INFO',
    ':INFO',
]
PSEUDOCONFIG_MAPPER = {
    'debug_rpc_answer': ['autanac:DEBUG', 'autanac.sql_db:INFO', 'autanac.http.rpc:DEBUG'],
    'debug_rpc': ['autanac:DEBUG', 'autanac.sql_db:INFO', 'autanac.http.rpc.request:DEBUG'],
    'debug': ['autanac:DEBUG', 'autanac.sql_db:INFO'],
    'debug_sql': ['autanac.sql_db:DEBUG'],
    'info': [],
    'warn': ['autanac:WARNING', 'werkzeug:WARNING'],
    'error': ['autanac:ERROR', 'werkzeug:ERROR'],
    'critical': ['autanac:CRITICAL', 'werkzeug:CRITICAL'],
}
