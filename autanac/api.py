...
"""The Autanac API module defines autanac Environments and method decorators.
...
from autanac.tools import frozendict, classproperty, lazy_property, StackMap
...
def constrains(*args):
    ...
    Should raise :exc:`~autanac.exceptions.ValidationError` if the
    validation failed.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/autanac/autanac/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~autanac.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~autanac.addons.base.models.res_users`"""
...
from autanac.exceptions import UserError, AccessError, MissingError
