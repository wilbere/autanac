...
from autanac.modules.module import get_module_root, MANIFEST_NAMES
from autanac.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the autanac server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            autanac.tools.config['init']['base'] = True
