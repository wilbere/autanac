...
def safe_eval(expr, globals_dict=None, locals_dict=None, mode="eval", nocopy=False, locals_builtins=False):
    ...
    except autanac.exceptions.except_orm:
        raise
    except autanac.exceptions.Warning:
        raise
    except autanac.exceptions.RedirectWarning:
        raise
    except autanac.exceptions.AccessDenied:
        raise
    except autanac.exceptions.AccessError:
        raise
    except werkzeug.exceptions.HTTPException:
        raise
    except autanac.http.AuthenticationError:
        raise
