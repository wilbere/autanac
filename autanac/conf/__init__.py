...
For now, configuration code is in autanac.tools.config. It is in mainly
...
To initialize properly this module, autanac.tools.config.parse_config()
must be used.

"""

# Paths to search for Auntanac addons.
addons_paths = []
...
# installed (i.e. the majority of Auntanac addons). This is set with the --load
# command-line option.
server_wide_modules = []
