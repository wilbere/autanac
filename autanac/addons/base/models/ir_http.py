...
import autanac
from autanac import api, http, models, tools, SUPERUSER_ID
from autanac.exceptions import AccessDenied, AccessError
from autanac.http import request, content_disposition
from autanac.tools import consteq, pycompat
from autanac.tools.mimetypes import guess_mimetype
from autanac.modules.module import get_resource_path, get_module_path

from autanac.http import ALLOWED_DEBUG_MODES
from autanac.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(autanac.conf.server_wide_modules)
            if tools.config['test_enable'] and autanac.modules.module.current_test:
                installed.add(autanac.modules.module.current_test)
