...
import autanac
from autanac.exceptions import UserError, ValidationError, AccessError
from autanac.tools import mute_logger
...
class TestServerActions(TestServerActionsBase):
    ...
    @mute_logger('autanac.addons.base.models.ir_model', 'autanac.models')
...
class TestCustomFields(common.TransactionCase):
    ...
    def test_create_unique(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('autanac.sql_db'):
            self.create_field('x_foo')
    ...
    @mute_logger('autanac.addons.base.models.ir_ui_view')
